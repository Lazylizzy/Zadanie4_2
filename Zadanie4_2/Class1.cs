...
namespace Zadanie4_2
{
    ...
    public class CreationModel : IExternalCommand
    {
        ...
        {
            FamilySymbol windowType = new FilteredElementCollector(doc) // с помощью фильтра получаем тип окна 
            ...
            XYZ point1 = hostCurve.Curve.GetEndPoint(0);		// левая крайняя точка 
            XYZ point2 = hostCurve.Curve.GetEndPoint(1);		// правая крайняя точка
